...
function DrawerTaskRow({ task, profiles, onSave, onAdd, onDelete, onDragStart, onDragOver, onDrop, isDragging, isDragTarget }) {
  ...
  return (
    ...
    >
      {/* drag handle */}
      <td style={{ padding: '7px 4px 7px 12px', width: 25, cursor: 'grab', borderBottom: '1px solid #9dc691', borderRight: '1px solid #9dc691' }}>
        <DragDots />
      </td>
          ...
          {items.map((item, idx) => {
            ...
            return (
              <Fragment key={item.id}>
                ...
                >
                  <td style={{ padding: '7px 4px 7px 12px', width: 25, cursor: 'grab', color: 'var(--text3)', fontSize: 14, userSelect: 'none', borderBottom: '1px solid #89bac9', borderRight: '1px solid #d5b6dd' }}>⠿</td>
                  <td style={{ padding: '4px 0', borderBottom: '1px solid #89bac9', borderRight: '1px solid #d5b6dd', textAlign: 'center' }}>
                    <button
                  ...
                  <td style={{ padding: '4px 12px', fontSize: 13, fontWeight: 600, color: 'var(--text)', borderBottom: '1px solid #89bac9', borderRight: '1px solid #d5b6dd' }}>
                  ...
                  <td style={{ padding: '7px 12px', fontSize: 12, color: 'var(--text3)', fontFamily: 'DM Mono, monospace', borderBottom: '1px solid #89bac9', borderRight: '1px solid #d5b6dd', textAlign: 'center' }}>{item.item_number || '—'}</td>
                  <td style={{ padding: '4px 12px', fontSize: 12, fontFamily: 'DM Mono, monospace', color: isOverdue ? 'var(--red)' : 'var(--text3)', fontWeight: isOverdue ? 600 : 400, borderBottom: '1px solid #89bac9', borderRight: '1px solid #d5b6dd' }}>
                        ...
                        <tbody>
                          {(itemProofs?.[item.id] || []).map(proof => (
                            <tr key={proof.id} className="proof-row" style={{ background: '#f2eaf4' }}>
                              ...
                              <td style={{ padding: '5px 12px', fontSize: 13, borderBottom: '1px solid #d5b6dd', borderRight: '1px solid #89bac9' }}>{item.name}</td>
                              <td style={{ padding: '5px 12px', fontFamily: 'DM Mono, monospace', fontSize: 12, borderBottom: '1px solid #d5b6dd', borderRight: '1px solid #89bac9', textAlign: 'center' }}>{item.item_number}{String.fromCharCode(64 + proof.version)}</td>
                              <td style={{ padding: '5px 12px', fontSize: 13, borderBottom: '1px solid #d5b6dd', borderRight: '1px solid #89bac9' }}>{proof.status || '—'}</td>
                              <td style={{ padding: '5px 12px', fontSize: 13, borderBottom: '1px solid #d5b6dd', borderRight: '1px solid #89bac9' }}>{proof.comments || '—'}</td>
